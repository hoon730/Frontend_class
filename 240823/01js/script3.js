...
// Callback 함수 중 가운데 어떤 요소라도 1개만 에러가 발생되는 경우, 열결되어있는
// 다른 Callback함수 실행에도 영향을 미친다!!!

// 그런데, 만약 Callback 함수가 많이 연결되어있는 경우에는 어떤 Callback 함수에서 에러가
// 발생되었는지 서칭 && 디버깅 하기가 매우 힘들다!!

// 생성자함수 혹은 클래스를 통해서 탄생된 프로타입 !!!
