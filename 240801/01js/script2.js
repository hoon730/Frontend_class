...
// window에 탑재된 시간 내장 함수에서 this를 
// 사용하면, 무조건 window

// 일반적인 콜백함수 내에서 주체가되고 있는
// 아이템을 찾아오고 싶을 때에는 직접 해당 인자를 
// 언급하거나 경우에 따라서 this 객체를 사용한다!
...
// 객체 안에 메서드 함수의 경우, this는 
// function의 경우, 해당 메서드 함수의 부모격인
// 객체를 찾아오지만, 만약 화살표 함수를 
// 사용한다면, window 객체를 찾아온다!! 
// const obj = {
//   vals: [1, 2, 3],
//   logValues: function() {
//     console.log(this);
...
// 객체 안에 메서드 형식으로 정의한 함수는
// 외부에 별도 존재하는 함수의 콜백함수로 사용할시,
// 기존 객체와의 관계성이 제거된다
// const arr3 = [4, 5, 6];
